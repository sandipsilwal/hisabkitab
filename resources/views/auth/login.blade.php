...
<body>
    ...
    <div class="login-card text-center">
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show text-start mb-3" style="background-color: rgba(34, 197, 94, 0.15); border: 1px solid rgba(34, 197, 94, 0.25); color: #86efac;" role="alert">
                {{ session('success') }}
        ...
        @if ($errors->any())
            <div class="alert alert-custom text-start">
                <ul class="mb-0 ps-3">
